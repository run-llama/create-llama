...
if UI_TEST:
    ...
    @pytest.mark.asyncio()
    async def test_ui_is_copied_and_mounted(server: LlamaIndexServer) -> None:
        """
        ...
        assert os.path.exists("./.ui/index.html"), (
    ...
    @pytest.mark.asyncio()
    async def test_component_router_addition(
        server: LlamaIndexServer, tmp_path: Path
    ) -> None:
        """
        ...
        component_route_exists = any(
            ...
            for route in component_server.routes
        )
